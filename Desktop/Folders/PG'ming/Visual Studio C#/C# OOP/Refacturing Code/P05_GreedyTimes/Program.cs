...
namespace P05_GreedyTimes
{
    ...
    public class Potato
    {
        ...
        private static void Print(Dictionary<string, Dictionary<string, long>> torba)
        {
        ...
        private static void Add(Dictionary<string, Dictionary<string, long>> torba,string[] seif,long vhod)
        {
            long zlato = 0;
            long kamuni = 0;
            long mangizi = 0;
