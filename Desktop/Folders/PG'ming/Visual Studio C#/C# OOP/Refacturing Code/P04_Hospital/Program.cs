...
namespace P04_Hospital
{
    public class Program
    {
        public static void Main()
        {
            ...
            Input(doktori, departments);
            Output(doktori, departments);
        }

        private static void Output(Dictionary<string, List<string>> doktori, Dictionary<string, List<List<string>>> departments)
        {
        ...
        private static void Input(Dictionary<string, List<string>> doktori, Dictionary<string, List<List<string>>> departments)
        {
            string command = Console.ReadLine();
